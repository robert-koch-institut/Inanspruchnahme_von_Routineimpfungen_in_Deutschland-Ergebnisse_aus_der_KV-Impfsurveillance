...
| `Respiratorisches Synzytial-Virus` | im Alter 0 bis 2 Monate | letztes Quartal des Beobachtungszeitraums | *Geburtsmonat April bis September* <br> K1: Alter 0 bis 2 Monate <br>K2: Januar bis März 2025|
...
| Respiratorisches Synzytial-Virus                                                                            | 1 Dosis   | 1 oder mehr Impfstoffdosen gelten als 1 Dosis
...
| Impfung                  | string  | Werte:<br>`Diphtherie, Tetanus, Pertussis`, `Diphtherie`, `Tetanus`, `Pertussis`, `Polio`, `Haemophilus influenzae Typ b (Hib)`, `Hepatitis B`, …                | Zielkrankheiten der eingesetzten Impfstoffe                                                                 |
| STIKO_Empfehlung         | string  | Werte:<br>`Standard`, `Indikation Grunderkrankungen`, `Indikation Schwangerschaft`                                                                               | Art der Impfempfehlung                                                                                      |
| Impfstatus               | string  | Werte:<br>`1 Dosis`, `1. Dosis`, `2. Dosis`, `3. Dosis`, `vollständig`, `Auffrischimpfung 5-8 Jahre`, `Auffrischimpfung 9-16 Jahre`                              | Ausprägung des Impfstatus                                                                                   |
| Altersgruppe             | string  | Werte:<br>`32 Wochen`, `15 Monate`, `24 Monate`, `36 Monate`, `48 Monate`, `60 Monate`, `72 Monate`, …                                                           | Alter, bis zu dem die Impfung in Anspruch genommen wurde                                                    |
