...
| Bevoelkerung_Gewicht     | number  | Werte: `≥1`<br>Fehlende Werte:<br>`NA`                                                                                                                                                      | Größe der Bevölkerung im jeweiligen Stratum (siehe [Berechnung der Impfquoten](#Berechnung-der-Impfquoten))                                                                                                                    |
| Impfquote                | number  | Werte: `0` - `100`<br>Fehlende Werte:<br>`NA`                                                                                                                                               | Anteil der geimpften Personen (siehe [Berechnung der Impfquoten](#Berechnung-der-Impfquoten))                                                                                                                                  |
